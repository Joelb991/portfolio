...
export default {
  ...
  detail: {
    ...
    overview: "Bandcamp Daily has picked an Album of the Day almost every weekday since 2011, and a feature there can make an unknown artist’s year. I scraped all 2,368 features, matched them to the Spotify Web API, cleaned 430 messy location strings into 80 countries, and loaded everything into a modelled Postgres warehouse on Supabase. A layer of SQL views defines every metric once, and a Tableau dashboard, six analysis notebooks and a live web app all read from it. The question: where does editorial attention actually go?",
    ...
    sections: [
      {
        ...
        items: [
          ...
          "The US share fell from 63.1% in 2017 to 44.2% in 2025, most of it in 2024–25 (2026 so far: 49.4%). The same writers shifted rather than new ones arriving (χ² p = 0.02)",
          "66.3% of features are self-released, and that share held between 60% and 71% every year",
          "The 15 most active of 349 writers produced 29.0% of all coverage; genre specialisation, measured as Shannon entropy, ranges from 0.24 to 3.15 bits",
          "City scenes are real but narrow: Pittsburgh metal (12 of 15 features) and Chicago jazz (27 of 98) clear the evidence bar, while clichés like Bristol trip-hop can’t even be tested",
        ],
      },
      {
        type: "highlights",
        title: "What I Built",
        items: [
          "Python ELT pipeline (extract → transform → enrich → load) that is incremental, cached and idempotent, with 96 pytest tests",
      ...
      },
      {
        ...
        items: [
          ...
          { src: `${P(SLUG)}/images/app-archive.jpg`, caption: "Archive — all 2,368 features, searchable and filterable" },
      ...
      {
        type: "data",
        title: "Analytics Table — 2,368 Features",
      ...
      },
      {
        type: "text",
        title: "Caveats",
        content: "Locations are record-label locations, not artist locations, and Bandcamp’s catalogue by country isn’t public, so coverage share describes what was featured rather than proving editorial preference; the trend over time is the robust part. “Self-released” is rule-derived, 13.1% of features carry no genre tag, and the 79.4% Spotify match rate is a lower bound on availability. Each caveat is stated on the page next to the number it qualifies.",
      },
    ],
  },
};
